    ...
    <div className="landing-background relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-12">
      ...
      >
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="section-kicker mb-3 block font-mono">Welcome back</p>
          ...
          <p className="mt-3 text-sm leading-6 text-teal-800/70">
            Start practicing faster and keep your progress synced across sessions.
          </p>
        </div>

        <SignIn routing="path" path="/sign-in" forceRedirectUrl="/dashboard" appearance={clerkAppearance} />

        <p className="mt-6 text-center text-sm text-teal-800/70">
          New to SATitude?{' '}
          <Link to="/sign-up" className="font-bold text-teal-700 hover:text-teal-800">
            Create an account
          </Link>
        </p>
      </motion.div>
